...
export const authors: Record<string, Author> = {
  'hannah-brooks': {
    ...
    image: 'https://i.pravatar.cc/256?u=hannah-brooks@petverdict.net',
  },
  'kevin-nguyen': {
    slug: 'kevin-nguyen',
    name: 'Kevin Nguyen',
    ...
    image: 'https://i.pravatar.cc/256?u=kevin-nguyen@petverdict.net',
  },
  'dr-lisa-ward': {
    slug: 'dr-lisa-ward',
    name: 'Dr. Lisa Ward',
    ...
    image: 'https://i.pravatar.cc/256?u=dr-lisa-ward@petverdict.net',
  },
};
